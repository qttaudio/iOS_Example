...
- (NSArray *)animationArray {
    ...
    if (_animationType == AnimationTypeWithBackground) {
        ...
        CABasicAnimation *scaleAnimation = [self scaleAnimation];
        CAKeyframeAnimation *blackBorderColorAnimation = [self borderColorAnimation];
...
//                                    (__bridge id)ColorWithAlpha(255, 241, 197, 0.5).CGColor,
//                                    (__bridge id)ColorWithAlpha(255, 241, 197, 0).CGColor];
    borderColorAnimation.values = @[(__bridge id)ColorWithAlpha(0, 145, 255, 0.5).CGColor,
                                    (__bridge id)ColorWithAlpha(0, 145, 255, 0.3).CGColor,
                                    (__bridge id)ColorWithAlpha(0, 145, 255, 0.1).CGColor,
                                    (__bridge id)ColorWithAlpha(0, 145, 255, 0).CGColor];
